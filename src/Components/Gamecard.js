const Gamecard = () => {
    return(
        ...
        <div class="row row-cols-1 row-cols-sm-2 g-2 m-3">
            <div class="col">
                <div class="card">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-house-add-fill mt-2 mx-2" viewBox="0 0 16 16">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Which Church were these messsages directed to</p>
                </div>
                </div>
            </div>
            <div class="col">
                <div class="card">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-quote mt-2 mx-2" viewBox="0 0 16 16">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Match a quote to the bible character involved</p>
                </div>
                </div>
            </div>
            <div class="col">
                <div class="card">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-megaphone-fill mt-2 mx-2" viewBox="0 0 16 16">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">This prophecy was made by which Prophet</p>
                </div>
                </div>
            </div>
            <div class="col">
                <div class="card">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-gem mt-2 mx-2" viewBox="0 0 16 16">
                ...
                <div class="card-body">
                    <h5 class="card-title">Kings</h5>
                    <p class="card-text">Identify which King commited these atrocity or good deed</p>
                </div>
                </div>
            </div>
        </div>
