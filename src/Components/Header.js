    ...
    return(
        ...
        <div class="container row mt-3 nav-fill">
            ...
            <ul class="nav nav-tabs col-10">
                <li class="nav-item">
                <a class="nav-link d-xs-inline d-sm-none" href="#">Home</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="#">Verses</a>
                </li>
                <li class="nav-item">
                {/* <a class="nav-link active" href="#">Heroes</a> */}
                <Link to='/heroes' className='nav-link active'>Heroes</Link>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="#">Apostles</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="">The Church</a>
                </li>
            </ul> 
        </div>
